 ...
 */
class FlotaControllerRuta extends FlotaController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('Ruta', 'FlotaModel');
    ...
    public function publish() {
        ...
        if ($user->authorise('core.edit', 'com_flota') || $user->authorise('core.edit.state', 'com_flota')) {
            ...
            if (!$item) {
                ...
                $this->setRedirect(JRoute::_('index.php?option=com_flota&view=rutas', false));
            } else {
